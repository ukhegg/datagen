...
namespace datagen
{
	namespace limits
	{
		...
		void adjust_algorithm(random_source_base& r_source,
		                      details::alphabet_contains_limit_t<_Elem> const& limit,
		...
		template <class _Elem, class _Traits, class _Alloc>
		void adjust_algorithm(random_source_base& r_source,
		                      details::alphabet_does_not_contain_limit_t<_Elem> const& limit,
		                      value_generation_algorithm<std::basic_string<_Elem, _Traits, _Alloc>>& alg_params)
		{
		...
		template <class _Elem, class _Traits, class _Alloc>
		void adjust_algorithm(random_source_base& r_source,
		                      details::container_size_limit_t const& limit,
		                      value_generation_algorithm<std::basic_string<_Elem, _Traits, _Alloc>>& alg_params)
		{
